...
void Machine_Description::initialize_instruction_table()
{
	...
	spim_instruction_table[neg] = new Instruction_Descriptor(neg, "uminus", "neg", "", i_op_r_o1, a_op_r_o1);
	spim_instruction_table[negf] = new Instruction_Descriptor(negf, "uminus.d", "neg.d", "", i_op_r_o1, a_op_r_o1);
...
Register_Descriptor* Machine_Description::get_register(Spim_Register reg){
	...
	CHECK_INVARIANT(CONTROL_SHOULD_NOT_REACH, 
			"Error could not find required reg");
}
