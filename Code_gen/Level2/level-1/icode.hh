...
///////////////////////////////////////////////////////////////
class CJump_IC_Stmt: public Icode_Stmt
{ 
	Ics_Opd * opd1;   
	Ics_Opd * opd2;
	Ics_Opd * result; 
...
public:
	CJump_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1, Ics_Opd * opd2,  Ics_Opd * result); 
	~CJump_IC_Stmt() {} 
	CJump_IC_Stmt & operator=(const CJump_IC_Stmt & rhs);
