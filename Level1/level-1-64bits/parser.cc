// Generated by Bisonc++ V2.09.03 on Wed, 05 Feb 2014 12:07:59 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {303, 3}, // 29: expression ->  expression relational_op atmoic_expression
     {303, 3}, // 30: expression ->  expression equality_op atmoic_expression
     {304, 1}, // 31: atmoic_expression ->  variable
     {304, 1}, // 32: atmoic_expression ->  constant
     {305, 4}, // 33: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP expression ';'
     {306, 1}, // 34: variable (NAME) ->  NAME
     {307, 1}, // 35: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {308, 1}, // 36: program_$ ->  program
};
...
{
    { { REQ_TOKEN}, {  6} },                     
    { {       304}, { 56} }, // atmoic_expression
    { {       306}, { 57} }, // variable         
    { {       307}, { 58} }, // constant         
    { {       258}, { 37} }, // NAME             
    { {       257}, { 59} }, // INTEGER_NUMBER   
    { {         0}, {  0} },                     
};
