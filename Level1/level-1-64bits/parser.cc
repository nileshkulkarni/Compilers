// Generated by Bisonc++ V2.09.03 on Wed, 05 Feb 2014 12:36:41 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {301, 1}, // 23: equality_op (NE) ->  NE
     {301, 1}, // 24: equality_op (EQ) ->  EQ
     {302, 1}, // 25: relational_op (LT) ->  LT
     {302, 1}, // 26: relational_op (GT) ->  GT
     {302, 1}, // 27: relational_op (GE) ->  GE
     {302, 1}, // 28: relational_op (LE) ->  LE
     {303, 3}, // 29: expression (GE) ->  expression GE expression
     {303, 3}, // 30: expression (LE) ->  expression LE expression
     {303, 3}, // 31: expression (LT) ->  expression LT expression
     {303, 3}, // 32: expression (GT) ->  expression GT expression
     {303, 3}, // 33: expression (EQ) ->  expression EQ expression
     {303, 3}, // 34: expression (NE) ->  expression NE expression
     {303, 1}, // 35: expression ->  atmoic_expression
     {304, 1}, // 36: atmoic_expression ->  variable
     {304, 1}, // 37: atmoic_expression ->  constant
     {305, 4}, // 38: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP expression ';'
     {306, 1}, // 39: variable (NAME) ->  NAME
     {307, 1}, // 40: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {308, 1}, // 41: program_$ ->  program
};
