// Generated by Bisonc++ V2.09.03 on Wed, 05 Feb 2014 12:52:57 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 2}, // 12: basic_block_list ->  basic_block_list basic_block
     {297, 1}, // 13: basic_block_list ->  basic_block
     {298, 3}, // 14: basic_block (BASIC_BLOCK) ->  BASIC_BLOCK ':' executable_statement_list
     {299, 1}, // 15: executable_statement_list ->  assignment_statement_list
     {299, 3}, // 16: executable_statement_list (RETURN) ->  assignment_statement_list RETURN ';'
     {299, 2}, // 17: executable_statement_list ->  assignment_statement_list goto_statement
     {299, 2}, // 18: executable_statement_list ->  assignment_statement_list if_else_statement
     {300, 0}, // 19: assignment_statement_list ->  <empty>
     {300, 2}, // 20: assignment_statement_list ->  assignment_statement_list assignment_statement
     {301, 7}, // 21: if_else_statement (IF) ->  IF '(' expression ')' goto_statement ELSE goto_statement
     {302, 3}, // 22: goto_statement (GOTO) ->  GOTO BASIC_BLOCK ';'
     {303, 1}, // 23: equality_op (NE) ->  NE
     {303, 1}, // 24: equality_op (EQ) ->  EQ
     {304, 1}, // 25: relational_op (LT) ->  LT
     {304, 1}, // 26: relational_op (GT) ->  GT
     {304, 1}, // 27: relational_op (GE) ->  GE
     {304, 1}, // 28: relational_op (LE) ->  LE
     {305, 1}, // 29: atmoic_expression ->  variable
     {305, 1}, // 30: atmoic_expression ->  constant
     {306, 1}, // 31: relational_expression ->  atmoic_expression
     {306, 3}, // 32: relational_expression (GE) ->  relational_expression GE relational_expression
     {306, 3}, // 33: relational_expression (LE) ->  relational_expression LE relational_expression
     {306, 3}, // 34: relational_expression (LT) ->  relational_expression LT relational_expression
     {306, 3}, // 35: relational_expression (GT) ->  relational_expression GT relational_expression
     {307, 1}, // 36: equality_expression ->  relational_expression
     {307, 3}, // 37: equality_expression (EQ) ->  equality_expression EQ relational_expression
     {307, 3}, // 38: equality_expression (NE) ->  equality_expression NE relational_expression
     {308, 1}, // 39: expression ->  equality_expression
     {309, 4}, // 40: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP expression ';'
     {310, 1}, // 41: variable (NAME) ->  NAME
     {311, 1}, // 42: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {312, 1}, // 43: program_$ ->  program
};
...
{
    { { REQ_TOKEN}, { 5} },                         
    { {       290}, { 7} }, // procedure_name       
    { {       296}, { 8} }, // declaration_statement
    { {       258}, { 5} }, // NAME                 
    { {       260}, { 6} }, // INTEGER              
    { {         0}, { 0} },                         
};
...
{
    { { REQ_TOKEN}, {  7} },                              
    { {       295}, { 18} }, // declaration_statement_list
    { {       297}, { 19} }, // basic_block_list          
    { {       296}, {  4} }, // declaration_statement     
    { {       298}, { 20} }, // basic_block               
    { {       260}, {  6} }, // INTEGER                   
    { {       265}, { 21} }, // BASIC_BLOCK               
...
{
    { { DEF_RED}, {   3} },                             
    { {     299}, {  27} }, // executable_statement_list
    { {     300}, {  28} }, // assignment_statement_list
    { {       0}, { -19} },                             
};
...
SR__ s_28[] =
{
    { { REQ_DEF}, {   9} },                        
    { {     259}, {  30} }, // RETURN              
    { {     302}, {  31} }, // goto_statement      
    { {     301}, {  32} }, // if_else_statement   
    { {     309}, {  33} }, // assignment_statement
    { {     263}, {  34} }, // GOTO                
    { {     261}, {  35} }, // IF                  
    { {     310}, {  36} }, // variable            
    { {     258}, {  37} }, // NAME                
...
SR__ s_40[] =
{
    { { REQ_TOKEN}, {  9} },                         
    { {       308}, { 43} }, // expression           
    { {       307}, { 44} }, // equality_expression  
    { {       306}, { 45} }, // relational_expression
    { {       305}, { 46} }, // atmoic_expression    
    { {       310}, { 47} }, // variable             
    { {       311}, { 48} }, // constant             
    { {       258}, { 37} }, // NAME                 
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 23:
        {
         d_val__.op = Expression_Ast::OperatorType::NE; 
         }
        break;

        case 24:
        {
         d_val__.op = Expression_Ast::OperatorType::EQ; 
        }
        break;

        case 25:
        {
         d_val__.op = Expression_Ast::OperatorType::LT; 
         }
        break;

        case 26:
        {
         d_val__.op = Expression_Ast::OperatorType::GT; 
         }
        break;

        case 27:
        {
         d_val__.op = Expression_Ast::OperatorType::GE; 
         }
        break;

        case 28:
        {
         d_val__.op = Expression_Ast::OperatorType::LE; 
         }
        break;
